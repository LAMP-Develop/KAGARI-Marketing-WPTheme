...
<section id="s-strength-sub" class="">
...
<li>
  ...
  <img src="<?php echo get_field('service_photo'); ?>" alt="<?php echo get_field('サービス写真'); ?>">
  </div>
</li>
<?php for ($i=1; $i <= 3; ++$i): ?>
<li class="strength-inner">
<h3 class="ttl3 mb-1"><span class="mr-2">0<?php echo $i; ?></span><?php echo preg_replace("/( |　)/", '', get_field('strength_ttl_'.$i)); ?></h3>
<div class="txt-wrap">
<p class="mt-1"><?php echo preg_replace("/( |　)/", '', get_field('strength_content_'.$i)); ?></p>
</div>
</li>
<?php endfor; ?>
</ul>
