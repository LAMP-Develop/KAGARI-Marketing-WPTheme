...
get_header(); ?>
<section id="pr-mv" class="sub-mv">
<div class="wrap txt-c">
<h2>PRESS RELEASE</h2>
<p class="m-0">プレスリリース</p>
</div>
</section>
...
<ul class="news-cats">
  ...
  <li class="selected"><a href="<?php echo $home; ?>/newslist/pr/"><i class="fas fa-tag"></i>プレスリリース</a></li>
  <li><a href="<?php echo $home; ?>/newslist/event/"><i class="fas fa-tag"></i>イベント・セミナー</a></li>
</ul>
<ul class="news-list">
<?php
include_once(ABSPATH . WPINC . '/rss.php');
$rss = fetch_rss('https://lamp.jp/newslist/press-release/feed');
$maxitems = 10;
