...
<div class="wrap txt-c">
<img src="<?php echo $wp_url; ?>/lib/images/service-main/cm/service_icon.svg" alt="サービスのアイコン">
<h2 class="ttl2">コンテンツマーケティング<br></h2>
<span class="eng mb-2">content marketing</span>
